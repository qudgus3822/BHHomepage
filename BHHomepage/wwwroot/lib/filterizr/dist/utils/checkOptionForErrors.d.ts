 ...
 */
export declare const checkOptionForErrors: (name: string, value: string | number | object | Function | any[] | boolean, type?: string, allowed?: any[] | RegExp, furtherHelpLink?: string) => void;
